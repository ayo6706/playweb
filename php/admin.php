                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-8 col-xs-8">
                                                ...
                                                <a href="editor.php?epr=blog&action=post"  class="btn btn-success" onclick="#"><i class="fa fa-asterisk"></i> Create</a>
			...
			while ($row=mysqli_fetch_assoc($result)) {
				echo '    
                                                    <tr>
                                                        ...
                                                        <td>02/4/2018</td>
                                                        <td>
                                                        	<a href="editor.php?action=edit&epr=blog&id='.$row['id'].'" 
